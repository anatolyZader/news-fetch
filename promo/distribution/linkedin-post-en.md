...
Most "AI for crisis" tools fail the same way: they compress everything into one confident number and hide what's behind it.

We built **Srulik's lab** to do the opposite.

It's a daily homefront resilience assessment across eight community-resilience components (the Home Front Command framework), drawn from news, radio, social media, search trends, and field reports. Three design choices we care about:
...
The hard part of decision-support isn't generating an answer. It's making the evidence behind the answer openable.

Happy to walk through the design with anyone working on high-stakes AI. → srulik.ai

#ResponsibleAI #DecisionSupport #CommunityResilience
