...
## Hard limit I can't do for you

**Domain registration** (`srulik.ai`) is a real-world action, not a file — register/verify it before any asset pointing to the URL ships, or the QR and CTAs dead-end.
