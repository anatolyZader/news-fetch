# "Do Not Say" — compliance pass for every srulik.ai draft

> Run **every** AI-generated asset through this checklist before it leaves the building. This product touches homefront / Pikud HaOref-adjacent security context. Over-claiming is not just bad marketing — it's a trust and safety problem. When in doubt, under-claim.

---

## Hard bans (never, in any language, in any asset)
...
Don't reference these even to explain them. The promo story is: *daily assessment → open the evidence → ask the reports (chat) → contribute from the field.*

---

## Tone rules

- Calm, professional, government/military register. **No AI hype**, no exclamation-mark energy, no "revolutionary."
- Lead with **evidence and the eight components** — never lead with a number.
- Hebrew field copy: respectful, operational, reassuring — not salesy.

---

## Per-asset checklist (tick before sending)
...
- [ ] HE RTL renders correctly on any PDF.

---

## The one-sentence test

If a sentence would still sound true after deleting the word "AI," keep it. If it only sounds impressive *because* it says "AI," cut it.
