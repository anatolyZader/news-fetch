...
- **Cause**: deployment missing `cross-cut-modules/docs/content/pages/` (or server route isn’t running)
- **Fix**: redeploy including `cross-cut-modules/docs/content/pages/`, restart.
