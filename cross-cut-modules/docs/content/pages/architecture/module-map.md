...
5. Write a guide under `cross-cut-modules/docs/content/pages/guides/` describing how to use it.
...
5. If the tab should appear in the Docs panel, write a guide in `cross-cut-modules/docs/content/pages/guides/` — the panel picks it up automatically.
