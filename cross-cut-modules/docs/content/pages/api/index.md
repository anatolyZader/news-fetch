...
## Constraints
- **`openapi/openapi.yaml` is the source of truth.** Don't hand-edit the generated endpoint pages in `cross-cut-modules/docs/content/pages/api/generated/` — they're regenerated on build from the YAML.
