...
export const SIGNAL_CATALOG = [
  ...
  { type: 'service_disruption', domain: 'continuity', signal_class: 'structural_state', label: 'Essential services, schools, or businesses are closed/disrupted', defaultPolarity: 'negative',
    disambiguation: {
      ...
      accept_patterns: [
        'restaurant closed due to rocket fire',
        'factory operations halted in the envelope',
        'churches or holy sites closed; worship without public attendance due to war',
      ],
  ...
  { type: 'routine_disruption', domain: 'continuity', signal_class: 'structural_state', label: 'Civilian daily routines (commuting, shopping, leisure, social rhythms) are visibly disrupted by the emergency — distinct from named-institution closures, which are service_disruption', defaultPolarity: 'negative',
    disambiguation: {
      not_confused_with: ['early_warning_system_failure', 'compliance_enter_shelter', 'harm_to_population', 'service_disruption'],
      accept_patterns: [
        'field visit: empty streets, no movement of residents, shops closed for days',
        'sustained inability to commute or maintain daily rhythms during emergency',
      ],
      reject_patterns: [
        'siren or missile alert city list with no resident behavior (אזעקות הופעלו ב…) → abstain',
        'per-salvo headline without routine change or coping behavior',
      ],
    },
  },
  ...
  { type: 'infrastructure_damage_acute', domain: 'continuity', signal_class: 'event', label: 'Physical damage to power, roads, water, or buildings from the emergency', defaultPolarity: 'negative', scoringPriors: { expected_phases: ['response', 'recovery'], temporal_half_life_days: 21 },
    disambiguation: {
      not_confused_with: ['harm_to_population', 'service_disruption'],
      accept_patterns: ['kindergarten damaged in Nahariya', '161 schools and kindergartens hit during the war', 'power lines down after rocket impact'],
      reject_patterns: ['people wounded or killed without building/infrastructure damage fact → harm_to_population'],
    },
  },
  ...
  { type: 'institutional_abandonment_perception', domain: 'narrative', signal_class: 'narrative', label: 'Residents describe feeling abandoned or forgotten by state institutions during the emergency', defaultPolarity: 'negative', mirror: 'resilience_narrative_positive',
    disambiguation: {
      not_confused_with: ['political_distrust', 'resource_shortage', 'coordination_failure', 'dependency_on_external_aid'],
      accept_patterns: ['residents say the state forgot us in the north', 'evacuees feel the state abandoned us with no timeline'],
      reject_patterns: [
        'named policy demand with specific accountability target → political_distrust',
        'community lacks backbone / גרעין קהילתי / internal organizing gap → coordination_failure or dependency_on_external_aid',
        'officer recommends welfare coordination for leadership or joint activity → coordination_failure',
        'material supply shortage without abandonment framing → resource_shortage',
      ],
    },
  ...
  { type: 'harm_to_population', domain: 'wellbeing', signal_class: 'event', label: 'Physical harm occurred in the community: casualties, injuries, civilians wounded or killed', defaultPolarity: 'negative', scoringPriors: {"expected_phases":["response","recovery"],"time_horizon":"instant","reversibility":"irreversible","allowed_intensities":["moderate","severe"],"expects_quantification":true,"intensity_floor":"moderate","temporal_half_life_days":30},
    disambiguation: {
      not_confused_with: ['solidarity_help_others', 'near_miss_reported', 'infrastructure_damage_acute'],
      accept_patterns: ['61-year-old injured by shrapnel from Hezbollah rocket barrage in Tamra', 'מספר בני אדם נפצעו באורח קל בקריית שמונה'],
      reject_patterns: [
        'traffic accident',
        'hiking fall',
        'off-duty crime',
        'criminal shooting, gang violence, or domestic street assault (אירוע אלימות, מטווח אפס) without war/emergency attack framing',
        'national EMS cumulative roll-up counts (מגן דוד אדום treated 2,223 since operation start)',
        'building, school, or kindergarten damaged with no people injured → infrastructure_damage_acute',
      ],
    },
  },
