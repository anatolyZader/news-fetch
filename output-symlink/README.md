...
Symlinks only. **Canonical storage stays module-owned** under `business_modules/*/data/`, `business_modules/resilience_scorer/developer/data/`, and `logs/`. This tree is for browsing and user access without moving pipeline paths.
...
|------|------------------|----------|
| **production/** | | User daily pipeline |
...
| **research/** | | Calibration — not auto-served to users |
...
- `business_modules/resilience_scorer/developer/domain/services/artifactPaths.js`
