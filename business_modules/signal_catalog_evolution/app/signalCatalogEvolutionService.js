/**
 * Signal catalog evolution — cluster OOV captures and produce analyst gap reports.
 */
...
export class SignalCatalogEvolutionService {
  /**
   * @param {object} deps
  ...
  async buildGapReport(opts = {}) {
    ...
    if (signalCatalogEvolutionRagEnabled() && opts.retrieval?.hybridRetrieve) {
