...
export const LABELS = {
  en: {
    ...
    staleNoticeTitle: 'Not today’s report',
    staleNoticeBody: 'This digest shows the most recently generated report, dated {date}. Today is {today}.',
    ...
    subject: "Srulik's Lab — digest",
    openInApp: "Open in Srulik's Lab",
  ...
  he: {
    ...
    staleNoticeTitle: 'הדוח אינו של היום',
    staleNoticeBody: 'הדיוור מציג את הדוח האחרון שהופק, מתאריך {date}. היום {today}.',
    ...
    subject: "Srulik's Lab — דיוור יומי",
    openInApp: "פתיחה ב־Srulik's Lab",
  ...
  ru: {
    ...
    staleNoticeTitle: 'Отчёт не за сегодня',
    staleNoticeBody: 'В дайджесте показан последний сформированный отчёт от {date}. Сегодня {today}.',
    ...
    subject: "Srulik's Lab — дайджест",
    openInApp: "Открыть в Srulik's Lab",
