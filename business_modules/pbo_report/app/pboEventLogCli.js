...
import { runPboEventLogAnalysisFromParsed } from './pboEventLogAnalysisService.js';
...
export async function runPboEventLogCli() {
  ...
  const outputBase =
    ...
    resolve('business_modules/pbo_report/data/muni/reports', `event-report-${reportDate}`);
