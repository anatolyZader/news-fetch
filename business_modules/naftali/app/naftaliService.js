/**
 * Service for Naftali weekly questionnaire data.
 *
 * Primary source: Google Sheets (live, updated when someone fills the form).
 * Fallback: local Excel files in business_modules/naftali/.
 *
...
import { fetchNaftaliResponses } from '../infrastructure/googleSheetsAdapter.js';
