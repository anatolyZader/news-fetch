...
export const SIGNAL_CATALOG = [
  ...
  { type: 'solidarity_help_others', domain: 'social', signal_class: 'behavior', label: 'Residents help neighbors, strangers, or community members', defaultPolarity: 'positive', mirror: 'social_isolation',
    disambiguation: {
      ...
      accept_patterns: ['brought food to elderly neighbors unable to reach shelters'],
  ...
  { type: 'leadership_clear_guidance', domain: 'leadership', signal_class: 'structural_state', label: 'Leadership provides clear, specific directions', defaultPolarity: 'positive',
    disambiguation: {
      ...
      accept_patterns: ['mayor announced shelter hours', 'HFC approved easing of restrictions for northern residents'],
  ...
  { type: 'feedback_channel_blocked', domain: 'information', signal_class: 'structural_state', label: 'Public feedback/inquiry channels are absent, unreachable, or ignored (hotline down, no response, no way to ask/clarify)', defaultPolarity: 'negative',
    disambiguation: {
      reject_patterns: ['requests recorded via a working channel → the need type'],
    },
  },
  ...
  { type: 'resilience_narrative_positive', domain: 'narrative', signal_class: 'narrative', label: 'Residents explicitly characterize the community\'s collective coping ("we are managing/strong") — collective self-assessment statements ONLY, never the concrete facts behind them', defaultPolarity: 'positive',
    disambiguation: {
      not_confused_with: ['service_continuity', 'leadership_clear_guidance', 'solidarity_help_others', 'calm_confidence'],
  ...
  { type: 'harm_to_population', domain: 'wellbeing', signal_class: 'event', label: 'Physical harm occurred in the community: casualties, injuries, civilians wounded or killed', defaultPolarity: 'negative',
    disambiguation: {
      ...
      accept_patterns: ['61-year-old injured by shrapnel from rocket barrage in Tamra'],
  ...
  { type: 'population_survey_finding', domain: 'wellbeing', signal_class: 'structural_state', label: 'FALLBACK ONLY: named survey/institutional finding that fits no substantive type. Prefer the substantive type (e.g. sleep_disruption_population) with evidence_type named_survey_statistic. Set polarity_override: positive for favorable findings (high compliance, high confidence).', defaultPolarity: 'negative', related: ['positive_wellbeing_marker'],
    disambiguation: {
      ...
      reject_patterns: [
        ...
        'finding fitting a substantive type → that type (sleep % → sleep_disruption_population)',
      ],
    },
  ...
  { type: 'protective_infrastructure_present', domain: 'preparedness', signal_class: 'capacity', indicator_kind: 'capacity', label: 'Protective infrastructure exists and is functional (mamad, shelters, safe rooms)', defaultPolarity: 'positive' },
  { type: 'protective_infrastructure_absent', domain: 'preparedness', signal_class: 'capacity', indicator_kind: 'capacity', label: 'Protective infrastructure missing or non-functional for households/institutions', defaultPolarity: 'negative' },
  { type: 'household_readiness_demonstrated', domain: 'preparedness', signal_class: 'capacity', indicator_kind: 'capacity', label: 'Households demonstrate emergency readiness (stocked kits, practiced plans)', defaultPolarity: 'positive' },
  { type: 'household_readiness_gap', domain: 'preparedness', signal_class: 'capacity', indicator_kind: 'capacity', label: 'Households lack basic emergency readiness (no mamad, no supplies, no plan)', defaultPolarity: 'negative' },
