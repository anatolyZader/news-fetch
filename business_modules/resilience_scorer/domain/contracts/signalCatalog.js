...
export const SIGNAL_CATALOG = [
  ...
  { type: 'compliance_follow_instructions', domain: 'compliance', signal_class: 'behavior', label: 'Residents follow official protective instructions', defaultPolarity: 'positive', mirror: 'non_compliance_ignore_guidelines' },
  { type: 'non_compliance_exit_early', domain: 'compliance', signal_class: 'behavior', label: 'Residents leave shelter before all-clear', defaultPolarity: 'negative', mirror: 'compliance_enter_shelter' },
  { type: 'non_compliance_ignore_guidelines', domain: 'compliance', signal_class: 'behavior', label: 'Residents ignore or dismiss safety guidelines', defaultPolarity: 'negative', mirror: 'compliance_follow_instructions' },
  { type: 'compliance_partial', domain: 'compliance', signal_class: 'behavior', label: 'Residents enter shelter or follow instructions incompletely (late entry, partial compliance)', defaultPolarity: 'positive', related: ['non_compliance_exit_early'] },
  { type: 'non_compliance_due_to_distrust', domain: 'compliance', signal_class: 'behavior', label: 'Residents refuse protective guidance because they distrust the source or alert system', defaultPolarity: 'negative', related: ['non_compliance_ignore_guidelines'],
    disambiguation: {
  ...
  { type: 'near_miss_reported', domain: 'risk', signal_class: 'event', label: 'Documented close call where protective measures barely prevented harm', defaultPolarity: 'negative',
    disambiguation: {
      not_confused_with: [
        'resilience_narrative_positive', 'resilience_narrative_negative', 'fear_narrative',
        'infrastructure_damage_acute', 'educational_disruption',
      ],
      accept_patterns: [
  ...
  { type: 'risk_trade_off_behavior', domain: 'risk', signal_class: 'behavior', label: 'Residents take calculated risk to reduce another harm (e.g. driving during alert to relieve childcare burden)', defaultPolarity: 'negative', related: ['risk_exposure_behavior'] },
  { type: 'public_order_breakdown', domain: 'risk', signal_class: 'event', label: 'Looting, crime wave, or breakdown of public order during the emergency (distinct from inter-group tension and shared-resource free-riding)', defaultPolarity: 'negative' },
  // Social Cohesion
  ...
  { type: 'social_isolation', domain: 'social', signal_class: 'behavior', label: 'Residents withdraw, are isolated, or excluded — including observed weakening of community ties, cohesion, or mutual involvement', defaultPolarity: 'negative', mirror: 'solidarity_help_others',
    disambiguation: {
      not_confused_with: ['resilience_narrative_negative', 'bridging_capital_failure'],
      reject_patterns: ['cross-line cooperation breakdown → bridging_capital_failure', 'scapegoating or inter-group friction → conflict_or_tension'],
    },
  },
  { type: 'conflict_or_tension', domain: 'social', signal_class: 'behavior', label: 'Reported conflicts, scapegoating, or inter-group tension', defaultPolarity: 'negative', mirror: 'conflict_resolution' },
  { type: 'conflict_resolution', domain: 'social', signal_class: 'behavior', indicator_kind: 'response', label: 'Community actors resolve conflicts constructively, enabling cooperation (mediation, compromise, de-escalation)', defaultPolarity: 'positive', mirror: 'conflict_or_tension' },
  ...
  { type: 'interfaith_solidarity', domain: 'social', signal_class: 'behavior', label: 'Constructive cooperation across religious lines during the emergency', defaultPolarity: 'positive', mirror: 'interfaith_tension' },
  { type: 'interfaith_tension', domain: 'social', signal_class: 'behavior', label: 'Conflict or tension specifically along religious lines', defaultPolarity: 'negative', mirror: 'interfaith_solidarity' },
  { type: 'help_seeking_behavior', domain: 'social', signal_class: 'behavior', indicator_kind: 'response', label: 'Residents actively ask neighbors or institutions for help (distinct from offering help)', defaultPolarity: 'positive' },
  { type: 'bridging_capital_demonstrated', domain: 'social', signal_class: 'behavior', label: 'Constructive cooperation across class, ethnic, or geographic lines (not only religious)', defaultPolarity: 'positive', mirror: 'bridging_capital_failure', related: ['interfaith_solidarity'] },
  { type: 'bridging_capital_failure', domain: 'social', signal_class: 'behavior', label: 'Cooperation across community lines breaks down or is blocked', defaultPolarity: 'negative', mirror: 'bridging_capital_demonstrated', related: ['interfaith_tension'] },
  ...
  { type: 'leadership_clear_guidance', domain: 'leadership', signal_class: 'structural_state', label: 'Leadership provides clear, specific directions', defaultPolarity: 'positive',
    disambiguation: {
      ...
      accept_patterns: ['mayor announced shelter hours', 'HFC approved easing of restrictions'],
      reject_patterns: ['pundit strategy commentary', 'accountability demand without actionable guidance'],
    },
  },
  ...
  { type: 'political_distrust', domain: 'leadership', signal_class: 'attitude', label: 'Residents or named civic figures publicly demand accountability or express distrust of the political/governmental handling of the emergency (specific policy demands, not general partisan opinion)', defaultPolarity: 'negative',
    disambiguation: {
      not_confused_with: ['leadership_credibility_loss', 'institutional_abandonment_perception'],
  ...
  { type: 'consensus_on_priorities', domain: 'leadership', signal_class: 'structural_state', label: 'Community actors reach working consensus on goals/priorities and a plan for action (collaboration, agreement on what to do next)', defaultPolarity: 'positive', mirror: 'dissensus_blocks_action' },
  { type: 'dissensus_blocks_action', domain: 'leadership', signal_class: 'structural_state', label: 'Mistrust/conflict prevents working consensus or blocks collective action (dissensus, infighting, inability to agree on priorities)', defaultPolarity: 'negative', mirror: 'consensus_on_priorities' },
  { type: 'coordination_failure', domain: 'leadership', signal_class: 'structural_state', label: 'Inter-agency or inter-organization coordination breaks down', defaultPolarity: 'negative', mirror: 'coordination_success' },
  { type: 'coordination_success', domain: 'leadership', signal_class: 'structural_state', label: 'Multiple agencies, services, or organizations coordinate effectively in response', defaultPolarity: 'positive', mirror: 'coordination_failure' },
  ...
  { type: 'civil_society_mobilization', domain: 'leadership', signal_class: 'structural_state', indicator_kind: 'response', label: 'NGOs or civil-society organizations step up with organized non-state response', defaultPolarity: 'positive' },
  ...
  { type: 'blame_shifting', domain: 'leadership', signal_class: 'attitude', label: 'Named leaders deflect responsibility rather than address the emergency', defaultPolarity: 'negative', mirror: 'responsibility_avowal' },
  ...
  { type: 'symbolic_vs_substantive_action', domain: 'leadership', signal_class: 'structural_state', label: 'Leadership visibility without substantive delivery (photo-ops, empty gestures)', defaultPolarity: 'negative', related: ['leadership_visible_presence'] },
  ...
  { type: 'information_clarity', domain: 'information', signal_class: 'structural_state', label: 'Residents report receiving clear, useful information', defaultPolarity: 'positive', mirror: 'information_confusion' },
  { type: 'information_confusion', domain: 'information', signal_class: 'structural_state', label: 'Residents report confusion, contradictory, or missing information', defaultPolarity: 'negative', mirror: 'information_clarity',
    disambiguation: {
      not_confused_with: ['information_overload', 'information_effectiveness_gap'],
  ...
  { type: 'rumor_correction', domain: 'information', signal_class: 'structural_state', indicator_kind: 'response', label: 'Authorities, experts, or community members visibly correct circulating rumors or misinformation', defaultPolarity: 'positive', mirror: 'rumor_spread' },
  { type: 'trusted_information_source', domain: 'information', signal_class: 'structural_state', label: 'Residents rely on or explicitly trust a specific local/official source for emergency information (trusted hotline, known local authority, trusted broadcaster)', defaultPolarity: 'positive', mirror: 'mistrusted_information_source' },
  { type: 'mistrusted_information_source', domain: 'information', signal_class: 'structural_state', label: 'Residents explicitly distrust or disregard an emergency information source (source seen as unreliable/lying/ignored), reducing adherence', defaultPolarity: 'negative', mirror: 'trusted_information_source' },
  { type: 'feedback_channel_open', domain: 'information', signal_class: 'structural_state', label: 'A working channel exists for the public to ask questions / articulate needs and receive responses (hotline, municipal desk, two-way messaging)', defaultPolarity: 'positive', mirror: 'feedback_channel_blocked' },
  { type: 'feedback_channel_blocked', domain: 'information', signal_class: 'structural_state', label: 'Public feedback/inquiry channels are absent, unreachable, or ignored (hotline down, no response, no way to ask/clarify)', defaultPolarity: 'negative', mirror: 'feedback_channel_open',
    disambiguation: {
  ...
  { type: 'information_actionable_effective', domain: 'information', signal_class: 'structural_state', label: 'Guidance is specific, situation-matched, and demonstrably leads to correct protective behavior', defaultPolarity: 'positive', mirror: 'information_effectiveness_gap',
    disambiguation: {
      ...
      reject_patterns: ['alert issuance without evidence of reception or response', 'community self-reliance or coping statements → narrative types'],
    },
  },
  { type: 'information_effectiveness_gap', domain: 'information', signal_class: 'structural_state', label: 'Guidance exists but fails to help — does not match real constraints, too vague to act on, or leaves critical scenarios uncovered', defaultPolarity: 'negative', mirror: 'information_actionable_effective' },
  { type: 'information_inclusivity_present', domain: 'information', signal_class: 'structural_state', label: 'Emergency information adapted for at-risk groups (Arabic translations, accessible formats, elder outreach, special-needs channels)', defaultPolarity: 'positive', mirror: 'information_inclusivity_gap' },
  { type: 'information_inclusivity_gap', domain: 'information', signal_class: 'structural_state', label: 'Emergency information not reaching at-risk groups (no Arabic, inaccessible formats, elders/disabled left uninformed)', defaultPolarity: 'negative', mirror: 'information_inclusivity_present',
    disambiguation: {
      not_confused_with: ['wellbeing_support_gap', 'protective_infrastructure_absent'],
      reject_patterns: ['needs-mapping or care service gaps → wellbeing_support_gap', 'shelter/protection gaps → protective_infrastructure_absent'],
    },
  },
  ...
  { type: 'media_literacy_demonstrated', domain: 'information', signal_class: 'behavior', indicator_kind: 'response', label: 'Ordinary residents (not authorities) visibly correct misinformation or verify claims', defaultPolarity: 'positive' },
  { type: 'information_overload', domain: 'information', signal_class: 'structural_state', label: 'Residents overwhelmed by volume of alerts or conflicting streams (distinct from confusion about content)', defaultPolarity: 'negative', related: ['information_confusion'] },
  ...
  { type: 'language_register_mismatch', domain: 'information', signal_class: 'structural_state', label: 'Emergency guidance uses register or language residents cannot understand or act on', defaultPolarity: 'negative', related: ['information_effectiveness_gap'] },
  ...
  { type: 'service_continuity', domain: 'continuity', signal_class: 'structural_state', label: 'Essential services or institutions are operating', defaultPolarity: 'positive', mirror: 'service_disruption' },
  { type: 'service_disruption', domain: 'continuity', signal_class: 'structural_state', label: 'Essential services, schools, or businesses are closed/disrupted', defaultPolarity: 'negative', mirror: 'service_continuity',
    disambiguation: {
      not_confused_with: ['economic_disruption', 'resource_shortage', 'routine_disruption'],
      accept_patterns: ['restaurant closed due to rocket fire'],
      reject_patterns: ['business owner expressing fear without closure fact'],
    },
  },
  { type: 'routine_maintenance', domain: 'continuity', signal_class: 'behavior', label: 'Residents maintain normal daily routines', defaultPolarity: 'positive', mirror: 'routine_disruption' },
  { type: 'routine_disruption', domain: 'continuity', signal_class: 'structural_state', label: 'Civilian daily routines (commuting, shopping, leisure, social rhythms) are visibly disrupted by the emergency — distinct from named-institution closures, which are service_disruption', defaultPolarity: 'negative', mirror: 'routine_maintenance',
    disambiguation: {
      not_confused_with: ['service_disruption', 'economic_disruption', 'evacuation_displacement'],
      reject_patterns: ['recurring institution closure → service_disruption'],
    },
  },
  { type: 'evacuation_displacement', domain: 'continuity', signal_class: 'event', label: 'Residents are evacuated, displaced, or unable to return home because of the emergency (named community, hotel/relative housing, prolonged absence)', defaultPolarity: 'negative', mirror: 'displacement_resolved',
    disambiguation: {
  ...
  { type: 'self_evacuation_unauthorized', domain: 'continuity', signal_class: 'behavior', label: 'Residents leave home or community without official evacuation order (self-evacuation, unauthorized departure)', defaultPolarity: 'negative', related: ['evacuation_displacement'],
    disambiguation: {
  ...
  { type: 'system_overload', domain: 'continuity', signal_class: 'structural_state', label: 'Systems (healthcare, emergency, infrastructure) are overwhelmed', defaultPolarity: 'negative', mirror: 'system_resilience_under_load',
    disambiguation: {
      ...
      reject_patterns: ['named service closure → service_disruption', 'workforce exhaustion → responder_workforce_strain'],
    },
  },
  ...
  { type: 'economic_continuity', domain: 'continuity', signal_class: 'structural_state', label: 'Local economic activity (employment, business, commerce) sustains during the emergency', defaultPolarity: 'positive', mirror: 'economic_disruption' },
  { type: 'economic_disruption', domain: 'continuity', signal_class: 'structural_state', label: 'Local economic activity is disrupted: business closures, lost income, employment freeze due to the emergency', defaultPolarity: 'negative', mirror: 'economic_continuity',
    disambiguation: { not_confused_with: ['service_disruption', 'household_strain_economic', 'resource_shortage'] },
  },
  { type: 'post_event_recovery_indicator', domain: 'continuity', signal_class: 'event', label: 'Communities visibly recover after a hit: re-opening, return of evacuees, resumed routines', defaultPolarity: 'positive' },
  { type: 'recovery_setback', domain: 'continuity', signal_class: 'event', label: 'Recovery reverses: reopened services close again, repairs fail, evacuees cannot stay home', defaultPolarity: 'negative' },
  ...
  { type: 'cultural_continuity', domain: 'continuity', signal_class: 'narrative', label: 'Identity-bearing rituals, ceremonies, holidays, or cultural events take place during the emergency', defaultPolarity: 'positive',
    disambiguation: {
      not_confused_with: ['service_disruption', 'religious_coping_practice', 'commemoration_event_observed'],
      accept_patterns: ['Passover seder held with community participation despite alerts', 'holiday ceremony proceeded with public attendance'],
      reject_patterns: [
  ...
  { type: 'rapid_mobilization', domain: 'continuity', signal_class: 'structural_state', indicator_kind: 'response', label: 'Resources/services are mobilized quickly to meet needs (rapid access, timely restoration, fast deployment)', defaultPolarity: 'positive' },
  ...
  { type: 'supply_chain_disruption', domain: 'continuity', signal_class: 'structural_state', label: 'Inputs to essential services fail (logistics, procurement, distribution)', defaultPolarity: 'negative', related: ['service_disruption'] },
  ...
  { type: 'infrastructure_damage_acute', domain: 'continuity', signal_class: 'event', label: 'Physical damage to power, roads, water, or buildings from the emergency', defaultPolarity: 'negative' },
  { type: 'connectivity_outage', domain: 'continuity', signal_class: 'structural_state', label: 'Telecom, internet, or mobile connectivity failure affecting emergency communication or daily function', defaultPolarity: 'negative', related: ['service_continuity'],
  ...
  { type: 'resilience_narrative_positive', domain: 'narrative', signal_class: 'narrative', label: 'Residents explicitly characterize the community\'s collective coping ("we are managing/strong") — collective self-assessment statements ONLY, never the concrete facts behind them', defaultPolarity: 'positive',
    disambiguation: {
      not_confused_with: ['leadership_clear_guidance', 'solidarity_help_others', 'calm_confidence'],
      accept_patterns: ['residents say we are managing fine despite the rockets'],
      reject_patterns: ['official declaring national spirit', 'list of closed businesses or empty streets', 'concrete helping act or functioning service → the concrete type'],
    },
  },
  { type: 'resilience_narrative_negative', domain: 'narrative', signal_class: 'narrative', label: 'Residents reject the coping story or describe the collective spirit as broken — collective self-assessment statements ONLY, never the concrete conditions behind them', defaultPolarity: 'negative',
    disambiguation: {
      not_confused_with: ['political_distrust', 'institutional_abandonment_perception', 'social_isolation', 'wellbeing_support_gap'],
      accept_patterns: ['the spirit in the north has broken'],
      reject_patterns: ['policy demand without community mood framing', 'cohesion or ties decline observed → social_isolation', 'welfare capacity strain → system_overload / wellbeing_support_gap', 'shelter/protection gaps → protective_infrastructure_absent', 'vulnerable left unsupported → wellbeing_support_gap', 'feels abandoned by state → institutional_abandonment_perception'],
    },
  },
  ...
  { type: 'self_organization', domain: 'resources', signal_class: 'behavior', indicator_kind: 'response', label: 'Community organizes itself without external direction', defaultPolarity: 'positive' },
  ...
  { type: 'local_capacity_demonstrated', domain: 'resources', signal_class: 'capacity', indicator_kind: 'capacity', label: 'Community demonstrates self-reliant capacity (own funds, own labour, own infrastructure) without leaning on outside aid', defaultPolarity: 'positive', mirror: 'dependency_on_external_aid' },
  { type: 'volunteer_donor_fatigue', domain: 'resources', signal_class: 'structural_state', label: 'Volunteer or donor capacity visibly exhausted in protracted emergency', defaultPolarity: 'negative' },
  { type: 'digital_mutual_aid', domain: 'resources', signal_class: 'behavior', indicator_kind: 'response', label: 'Crowdfunding, WhatsApp/Telegram mutual-aid channels mobilize resources', defaultPolarity: 'positive', related: ['self_organization'] },
  ...
  { type: 'harm_to_population', domain: 'wellbeing', signal_class: 'event', label: 'Physical harm occurred in the community: casualties, injuries, civilians wounded or killed', defaultPolarity: 'negative',
    disambiguation: {
  ...
  { type: 'wellbeing_support_gap', domain: 'wellbeing', signal_class: 'structural_state', label: 'At-risk individuals or groups cannot access needed psychological, welfare, or care support (unstaffed welfare services, elderly without care, trauma care unavailable)', defaultPolarity: 'negative', mirror: 'wellbeing_support_accessed',
    disambiguation: {
      not_confused_with: ['wellbeing_support_accessed', 'inequitable_resource_access'],
      accept_patterns: ['welfare department cannot reach homebound elderly', 'no entity holds a full picture of elderly and disabled'],
      reject_patterns: ['unequal access by subgroup → inequitable_resource_access', 'general supply shortage → resource_shortage'],
    },
  },
  { type: 'inequitable_resource_access', domain: 'wellbeing', signal_class: 'structural_state', label: 'Unequal access to safety/resources/services across subgroups (disparities, exclusion of vulnerable populations)', defaultPolarity: 'negative', mirror: 'equitable_resource_distribution' },
  { type: 'equitable_resource_distribution', domain: 'wellbeing', signal_class: 'structural_state', label: 'Resources/support are distributed fairly based on needs (equity-aware allocation, non-disparate access)', defaultPolarity: 'positive', mirror: 'inequitable_resource_access' },
  ...
  { type: 'domestic_violence_indicator', domain: 'wellbeing', signal_class: 'event', label: 'Reported fact of domestic violence increase — requires explicit evidence, never infer', defaultPolarity: 'negative' },
  { type: 'suicide_self_harm_indicator', domain: 'wellbeing', signal_class: 'event', label: 'Reported fact of suicide or self-harm — requires explicit evidence, never infer', defaultPolarity: 'negative' },
  { type: 'population_survey_finding', domain: 'wellbeing', signal_class: 'structural_state', label: 'FALLBACK ONLY: named survey/institutional finding that fits no substantive type. Prefer the substantive type (e.g. sleep_disruption_population) with evidence_type named_survey_statistic. Set polarity_override: positive for favorable findings (high compliance, high confidence).', defaultPolarity: 'negative', related: ['positive_wellbeing_marker'],
    disambiguation: {
  ...
  { type: 'positive_wellbeing_marker', domain: 'wellbeing', signal_class: 'attitude', label: 'Population-level gratitude, efficacy, or meaning-making (distinct from calm_confidence)', defaultPolarity: 'positive', related: ['population_survey_finding'] },
  ...
  { type: 'protective_infrastructure_present', domain: 'preparedness', signal_class: 'capacity', indicator_kind: 'capacity', label: 'Protective infrastructure exists and is functional (mamad, shelters, safe rooms)', defaultPolarity: 'positive', mirror: 'protective_infrastructure_absent' },
  { type: 'protective_infrastructure_absent', domain: 'preparedness', signal_class: 'capacity', indicator_kind: 'capacity', label: 'Protective infrastructure missing or non-functional for households/institutions', defaultPolarity: 'negative', mirror: 'protective_infrastructure_present' },
  { type: 'household_readiness_demonstrated', domain: 'preparedness', signal_class: 'capacity', indicator_kind: 'capacity', label: 'Households demonstrate emergency readiness (stocked kits, practiced plans)', defaultPolarity: 'positive', mirror: 'household_readiness_gap' },
  { type: 'household_readiness_gap', domain: 'preparedness', signal_class: 'capacity', indicator_kind: 'capacity', label: 'Households lack basic emergency readiness (no mamad, no supplies, no plan)', defaultPolarity: 'negative', mirror: 'household_readiness_demonstrated' },
  ...
  // Adaptation & Learning
  { type: 'adaptive_practice', domain: 'adaptation', signal_class: 'behavior', indicator_kind: 'response', label: 'Community visibly changes routines to cope (rooftop schools, distributed offices, reordered work week)', defaultPolarity: 'positive', mirror: 'failure_to_adapt' },
  ...
  { type: 'innovation_under_constraint', domain: 'adaptation', signal_class: 'behavior', indicator_kind: 'response', label: 'Community invents new method on the fly beyond routine adaptation', defaultPolarity: 'positive', related: ['adaptive_practice'] },
  ...
  { type: 'cross_event_learning', domain: 'adaptation', signal_class: 'structural_state', label: 'Explicit application of lessons from a prior emergency round', defaultPolarity: 'positive', related: ['lessons_learned_uptake'] },
  ...
  // Children & Education
  { type: 'educational_continuity', domain: 'education', signal_class: 'structural_state', label: 'Schools or childcare operate (in-person or protected remote) during emergency', defaultPolarity: 'positive', mirror: 'educational_disruption' },
  { type: 'educational_disruption', domain: 'education', signal_class: 'structural_state', label: 'Schools, kindergartens, or youth programs closed or severely disrupted', defaultPolarity: 'negative', mirror: 'educational_continuity' },
  { type: 'learning_loss_documented', domain: 'education', signal_class: 'structural_state', label: 'Documented learning loss from school disruption', defaultPolarity: 'negative', related: ['educational_continuity'] },
  ...
  { type: 'environmental_damage_acute', domain: 'environmental', signal_class: 'event', label: 'Acute environmental damage from rockets, fires, or military activity', defaultPolarity: 'negative' },
  ...
  // Hostage & Captivity
  { type: 'hostage_family_advocacy', domain: 'hostage', signal_class: 'behavior', indicator_kind: 'response', label: 'Hostage families organize advocacy or public pressure (documented activity)', defaultPolarity: 'positive' },
  { type: 'hostage_return_event', domain: 'hostage', signal_class: 'event', label: 'Hostage or captive returns home (documented event)', defaultPolarity: 'positive' },
  { type: 'hostage_uncertainty_distress', domain: 'hostage', signal_class: 'attitude', label: 'Distress from ongoing hostage uncertainty in the community', defaultPolarity: 'negative' },
  ...
  { type: 'deepfake_misinformation', domain: 'cyber', signal_class: 'structural_state', label: 'AI-generated or deepfake content spreads as emergency misinformation', defaultPolarity: 'negative', related: ['hostile_influence_operation'] },
];
