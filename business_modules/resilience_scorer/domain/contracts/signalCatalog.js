...
export const SIGNAL_CATALOG = [
  ...
  { type: 'information_actionable_effective', domain: 'information', signal_class: 'structural_state', label: 'Guidance is specific, situation-matched, and demonstrably leads to correct protective behavior', defaultPolarity: 'positive',
    disambiguation: {
      ...
      reject_patterns: ['alert issuance without evidence of reception or response'],
    },
  },
  ...
  { type: 'service_disruption', domain: 'continuity', signal_class: 'structural_state', label: 'Essential services, schools, or businesses are closed/disrupted', defaultPolarity: 'negative',
    disambiguation: {
      not_confused_with: ['economic_disruption', 'resource_shortage', 'fear_expression', 'routine_disruption', 'cultural_continuity'],
  ...
  { type: 'resilience_narrative_positive', domain: 'narrative', signal_class: 'narrative', label: 'Residents explicitly characterize the community\'s collective coping ("we are managing/strong") — collective self-assessment statements ONLY, never the concrete facts behind them', defaultPolarity: 'positive',
    disambiguation: {
      not_confused_with: ['service_continuity', 'routine_maintenance', 'leadership_clear_guidance', 'solidarity_help_others', 'calm_confidence'],
  ...
  { type: 'resilience_narrative_negative', domain: 'narrative', signal_class: 'narrative', label: 'Residents reject the coping story or describe the collective spirit as broken — collective self-assessment statements ONLY, never the concrete conditions behind them', defaultPolarity: 'negative',
    disambiguation: {
      not_confused_with: ['political_distrust', 'institutional_abandonment_perception', 'social_isolation', 'system_overload', 'wellbeing_support_gap'],
  ...
  { type: 'wellbeing_support_gap', domain: 'wellbeing', signal_class: 'structural_state', label: 'At-risk individuals or groups cannot access needed psychological, welfare, or care support (unstaffed welfare services, elderly without care, trauma care unavailable)', defaultPolarity: 'negative', mirror: 'wellbeing_support_accessed',
    disambiguation: {
      ...
      accept_patterns: ['welfare department cannot reach homebound elderly', 'no entity holds a full picture of elderly and disabled residents'],
      reject_patterns: ['unequal access across subgroups → inequitable_resource_access', 'general supply shortage → resource_shortage'],
    },
  },
  ...
  { type: 'population_survey_finding', domain: 'wellbeing', signal_class: 'structural_state', label: 'FALLBACK ONLY: named survey/institutional finding that fits no substantive type. Prefer the substantive type (e.g. sleep_disruption_population) with evidence_type named_survey_statistic. Set polarity_override: positive for favorable findings (high compliance, high confidence).', defaultPolarity: 'negative', related: ['positive_wellbeing_marker'],
    disambiguation: {
      ...
      accept_patterns: ['MDA: 790 injured reaching shelters during alerts (no substantive type fits)'],
      reject_patterns: [
        'single unnamed quote without survey source',
        'finding that fits a substantive type → that type (e.g. sleep % → sleep_disruption_population)',
      ],
    },
