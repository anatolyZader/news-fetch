/**
 * Per-component evidence requirements for interactive report building.
 *
 * This module is intentionally shared across channels (WhatsApp + Web).
 * It defines closed vocabularies and minimum required fields so that:
 * - the LLM prompts emit only allowed values
...
export const EVIDENCE_REQUIREMENTS = {
  narrative: {
    ...
    disambiguation: [{ dimension: 'framing', values: ['endurance', 'futility', 'mixed', 'other'] }],
  ...
  information_communication: {
    ...
    disambiguation: [
      {
        dimension: 'gap_type',
        values: ['unclear', 'inaccessible', 'contradictory', 'rumor', 'actionable_but_ignored', 'other'],
      },
    ],
  ...
  lifesaving_behavior: {
    ...
    disambiguation: [{ dimension: 'driver', values: ['fatigue', 'disbelief', 'access', 'distrust', 'practical', 'other'] }],
  ...
  community_capital: {
    ...
    disambiguation: [{ dimension: 'initiator', values: ['municipality', 'ngo', 'residents', 'businesses', 'mixed', 'other'] }],
  ...
  belonging_solidarity: {
    ...
    disambiguation: [{ dimension: 'tone', values: ['solidarity', 'scapegoating', 'indifference', 'mixed', 'other'] }],
  ...
  wellbeing_at_risk: {
    ...
    disambiguation: [
      {
        dimension: 'vulnerableGroup',
        values: ['elderly', 'disabled', 'children', 'evacuees', 'minorities', 'mentally_distressed', 'other'],
      },
