...
import { REGIONAL_PBO_REGION_IDS } from '../../../business_modules/pbo_report_regional/domain/value_objects/regionalPboRegions.js';
...
test('geo north subregion ids stay aligned with regional PBO region ids', () => {
  assert.deepEqual(
    ...
    'Update both lists together (pbo_report_regional/regionalPboRegions.js and geo/northSubregionId.js)',
  );
});
