  ...
  return [
    {
      ...
      overall_score: 6,
      components: [
        { component_id: 'narrative', score: 7, confidence: 'high', polarization: 0.1, evidence_mass: 8, signal_count: 5 },
    ...
    },
    {
      ...
      overall_score: 7,
      components: [
        { component_id: 'narrative', score: 8, confidence: 'high', polarization: 0.05, evidence_mass: 10, signal_count: 6 },
        { component_id: 'leadership', score: 6, confidence: 'high', polarization: 0.2, evidence_mass: 6, signal_count: 3 },
      ],
