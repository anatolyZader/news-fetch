...
import { DEFAULT_VALIDATION_CONFIG } from '../../../../../business_modules/resilience/validation/config/validationConfig.js';
import { summarizeValidationMaturity } from '../../../../../business_modules/resilience/validation/domain/validationStatus.js';
...
describe('validationStatus', () => {
  ...
  it('summarizeValidationMaturity counts records and pending review items', () => {
    ...
    const reviewDir = join(
      rootDir,
      'business_modules/resilience/validation/artifacts/review-queue',
    );
