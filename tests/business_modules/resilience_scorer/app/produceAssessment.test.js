...
import { produceAssessment } from '../../../../business_modules/resilience_scorer/app/assessment/produceAssessment.js';
...
describe('produceAssessment', () => {
  ...
  it('loads cached report when signals empty', async () => {
