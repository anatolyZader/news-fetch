...
import { createPboRegionalDailyService } from '../../../../business_modules/pbo_report/app/pboRegionalDailyService.js';
...
test('regional PBO service delegates markdown report listing by district and region', () => {
  ...
  assert.match(dashboard.inboxRelative, /pbo_report\/data/);
