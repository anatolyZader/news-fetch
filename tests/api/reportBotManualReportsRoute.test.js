...
test('GET /api/report-bot/manual-reports reads report_bot module data inbox', async (t) => {
  const inbox = join(PROJECT_ROOT, 'business_modules', 'report_bot', 'data');
  ...
  assert.equal(body.inboxRelative, 'business_modules/report_bot/data');
