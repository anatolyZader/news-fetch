...
/**
 * Append `district` query param for regional operator scope (national leaves URL unchanged).
 * @param {string} url
 * @param {string} [operatorScope]
 * @returns {string}
 */
export function withOperatorDistrictQuery(url, operatorScope) {
  const id = normalizeReportScopeId(operatorScope);
