...
export const assessmentShape = PropTypes.shape({
  ...
  investigation_summary: PropTypes.shape({
    ...
    signals_scoring_used: PropTypes.number,
    scoring_partition_applied: PropTypes.bool,
    scoring_assessment_mode: PropTypes.string,
    prior_quarantine_skipped: PropTypes.string,
