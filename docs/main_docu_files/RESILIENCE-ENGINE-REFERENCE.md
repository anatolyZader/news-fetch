...
> **Auto-synced** from `business_modules/resilience_scorer/domain/resilienceComponents.js` on 2026-07-18. Do not edit between sync markers.
...
> **Auto-synced** from `business_modules/resilience_scorer/domain/services/operator/componentFacets.js` on 2026-07-18. Do not edit between sync markers.
...
> **Auto-synced** from `resilienceComponents.js + componentFacets.js` on 2026-07-18. Do not edit between sync markers.
...
> **Auto-synced** from `client/src/i18n/translations.js (en + he)` on 2026-07-18. Do not edit between sync markers.
