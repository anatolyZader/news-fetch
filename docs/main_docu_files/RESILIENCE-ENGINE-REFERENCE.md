...
> **Auto-synced** from `business_modules/resilience_scorer/domain/resilienceComponents.js` on 2026-07-31. Do not edit between sync markers.
...
> **Auto-synced** from `min-math (componentFacets.js removed)` on 2026-07-31. Do not edit between sync markers.
...
> **Auto-synced** from `resilienceComponents.js` on 2026-07-31. Do not edit between sync markers.
...
> **Auto-synced** from `client/src/i18n/translations.js (en + he)` on 2026-07-31. Do not edit between sync markers.
