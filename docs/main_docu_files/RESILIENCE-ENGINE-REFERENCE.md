...
> **Auto-synced** from `resilienceComponents.js + componentFacets.js` on 2026-07-03. Do not edit between sync markers.
...
> **Auto-synced** from `client/src/i18n/translations.js (en + he)` on 2026-07-03. Do not edit between sync markers.
