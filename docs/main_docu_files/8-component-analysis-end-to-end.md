...
> **Auto-synced** from `business_modules/resilience/domain/resilienceComponents.js` on 2026-05-19. Do not edit between sync markers.
...
> **Auto-synced** from `business_modules/resilience/domain/services/componentFacets.js` on 2026-05-19. Do not edit between sync markers.
...
> **Auto-synced** from `resilienceComponents.js + componentFacets.js` on 2026-05-19. Do not edit between sync markers.
...
> **Auto-synced** from `client/src/i18n/translations.js (en + he)` on 2026-05-19. Do not edit between sync markers.
