...
5. Write a guide under `docs/product_docs/guides/` describing how to use it.
...
5. If the tab should appear in the Docs panel, write a guide in `docs/product_docs/guides/` — the panel picks it up automatically.
