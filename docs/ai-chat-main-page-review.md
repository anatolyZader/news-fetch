...
- Prompt/context construction and report grounding (`api/chatService.js`, `api/analysisService.js`)
...
- The report data is retrieved with `getCachedReport()` from `api/analysisService.js`.
...
- `api/chatService.js`
- `api/analysisService.js` (function: `getCachedReport`)
