...
Inventory and review process for npm dependencies in this monorepo (root app, `client/`, `docs/docs-site/`).
...
| `docs/docs-site/` | `docs/docs-site/package-lock.json` | `npm ci --prefix docs/docs-site` |
...
## Docs site (`docs/docs-site/package.json`)
...
2. `npm ls --prod` at root, `client/`, and `docs/docs-site/`.
