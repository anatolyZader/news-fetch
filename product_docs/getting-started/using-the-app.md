...
stability: beta
canonical: "https://docs.srulik.ai/getting-started/using-the-app"
version: "current"
...
- **I see "No assessment is available yet"**
  ...
  - **What to do**: ask your operator to run the daily pipeline for today (see [Operate the daily pipeline](https://docs.srulik.ai/guides/operating-daily-pipeline)).
...
- **I'm stuck in a sign-in loop / "Unauthorized"**
  ...
  - **What to do**: ask your operator to authorize your account or verify auth config (see [Auth setup](https://docs.srulik.ai/getting-started/auth-setup)).
- **A score looks wrong**
