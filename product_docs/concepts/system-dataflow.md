...
- **Useful**: Skimming the [Quickstart](../getting-started/quickstart.md) first so "ingest" and "report" aren't abstract.
...
- **Report looks correct but evidence feels missing**
  ...
  - **Fix**: rerun ingestion for the missing source/date, then regenerate the assessment. See [Operate the daily pipeline](../guides/operating-daily-pipeline.md).
